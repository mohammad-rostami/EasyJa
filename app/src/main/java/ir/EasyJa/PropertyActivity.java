...
public class PropertyActivity extends AppCompatActivity  implements FragmentNavigation.OnFragmentInteractionListener {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        toolbar_main_tv_header.setText("نوع ملک");
...
//            Toast.makeText(this, item, Toast.LENGTH_SHORT).show();
        ...
        wheelView.setOnWheelItemClickListener(new WheelView.OnWheelItemClickListener() {
            ...
            public void onWheelItemClick(WheelView parent, int position, boolean isSelected) {
                ...
                if (position == 0) {
//                    Intent intent = new Intent(PropertyActivity.this, CategoryActivity.class);
...
//                    PropertyActivity.this.startActivity(intent);
        ...
        wheelView.setAdapter(new WheelAdapter() {
            ...
            public Drawable getDrawable(int position) {
                if (position == 0) {
                    drawable = getResources().getDrawable(R.mipmap.ic_pink_2);
                } else if (position == 1) {
                    drawable = getResources().getDrawable(R.mipmap.ic_pink_1);
                } else {
