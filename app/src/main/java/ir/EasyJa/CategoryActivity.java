...
public class CategoryActivity extends AppCompatActivity implements FragmentNavigation.OnFragmentInteractionListener {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        toolbar_main_tv_header.setText("دسته بندی");
        ...
        wheelView.setOnWheelItemClickListener(new WheelView.OnWheelItemClickListener() {
            ...
            public void onWheelItemClick(WheelView parent, int position, boolean isSelected) {
                ...
                if (position == 0) {
                    Boolean going_to_rent = G.GOING_TO_RENT.getBoolean("GOING_TO_RENT", false);
                    if (going_to_rent) {
                        G.fromRent = true;
                        G.TYPE_ID = 1;
                        Boolean is_registered = G.IS_REGISTERED.getBoolean("IS_REGISTERED", false);
                        if (is_registered) {
                            Intent intent = new Intent(CategoryActivity.this, AddNewAds.class);
                            intent.putExtra("item", "1");
                            CategoryActivity.this.startActivity(intent);
                        } else {
                            Intent intent = new Intent(CategoryActivity.this, LoginActivity.class);
                            intent.putExtra("base","Category");
                            CategoryActivity.this.startActivity(intent);
                        }
                    } else {
        ...
        wheelView.setAdapter(new WheelAdapter() {
            ...
            public Drawable getDrawable(int position) {
                if (position == 0) {
                    drawable = getResources().getDrawable(R.mipmap.ic_purple_3);
                } else if (position == 1) {
                    drawable = getResources().getDrawable(R.mipmap.ic_purple_2);
                } else if (position == 2) {
                    drawable = getResources().getDrawable(R.mipmap.ic_purple_1);
                } else {
...
//        });
    ...
    public void setSelected(int no) {
        ValueAnimator valueAnimator = ValueAnimator.ofFloat(no, 0);
