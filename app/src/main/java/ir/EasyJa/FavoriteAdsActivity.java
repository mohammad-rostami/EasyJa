...
public class FavoriteAdsActivity extends AppCompatActivity implements View.OnClickListener, OnMapReadyCallback,
    ...
    public static FavoriteAdsActivity activity;
...
//        fragmentTransaction.commit();
        ...
        activity = FavoriteAdsActivity.this;
        ...
        adapter_recycler = new Adapter_Recycler_Ads(getApplicationContext(), arrayList, new OnItemListener() {
            ...
            public void onCardClick(int position) {
                Intent intent = new Intent(FavoriteAdsActivity.this, AdsActivityDetail.class);
                intent.putExtra("adID", String.valueOf(arrayList.get(position).AdsShift1_AdsId));
                FavoriteAdsActivity.this.startActivity(intent);
            }
...
//        String cellphone = G.CUSTOMER_MOBILE.getString("CUSTOMER_MOBILE", "0");
        ...
        new resendAsync().execute(Urls.BASE_URL + Urls.GetUserFavoriteAds, customerId);


    }

    private class resendAsync extends Webservice.getFavoriteAds {
        @Override
        protected void onPreExecute() {
            arrayList.clear();
