...
public final class CropImageFragment extends Fragment
     ...
     */
    public static CropImageFragment newInstance(CropDemoPreset demoPreset) {
...
//    }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        if (item.getItemId() == R.id.main_action_crop) {
            ...
            return true;
        } else if (item.getItemId() == R.id.main_action_select_image) {
    ...
    private void handleCropResult(CropImageView.CropResult result) {
        if (result.getError() == null) {
            Intent intent = new Intent(getActivity(), AddNewAds.class);
