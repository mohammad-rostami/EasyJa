...
//    mDrawerLayout.setDrawerListener(mDrawerToggle);
    ...
    if (CropImage.isExplicitCameraPermissionRequired(CropImageActivity.this)) {
...
//    }
    switch (item.getItemId()) {
      case android.R.id.home:
        ...
        Intent intent = new Intent(G.CONTEXT, AddNewAds.class);
  ...
  private void setMainFragmentByPreset(CropDemoPreset demoPreset) {
    ...
    fragmentManager
            .beginTransaction()
            .replace(R.id.container, CropImageFragment.newInstance(demoPreset))
            .commit();
  }
