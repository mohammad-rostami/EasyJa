...
public class ProfileActivity extends AppCompatActivity implements View.OnClickListener, OnMapReadyCallback,
    ...
    String url = Urls.BASE_URL + "Account/SetUserPhoto?Mobile=";
    private CardView going_to_be_reserved;
    private CardView reserved;
    private CardView manage;
    private CardView favorite_ads;
...
//        fragmentTransaction.commit();
        ...
        toolbar_main_tv_header.setText("پروفایل کاربری");
        ...
        going_to_be_reserved = (CardView) findViewById(R.id.going_to_be_reserved);
        reserved = (CardView) findViewById(R.id.reserved);
        manage = (CardView) findViewById(R.id.manage);
        favorite_ads = (CardView) findViewById(R.id.favorite_ads);

        going_to_be_reserved.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(ProfileActivity.this,MyAdsActivity_NotReserved.class);
        ...
        reserved.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(ProfileActivity.this,MyAdsActivity_Reserved.class);
                ProfileActivity.this.startActivity(intent);
            }
        });
        ...
        manage.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(ProfileActivity.this,ManageAdsActivity.class);
                ProfileActivity.this.startActivity(intent);
            }
        });
        favorite_ads.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(ProfileActivity.this,FavoriteAdsActivity.class);
                ProfileActivity.this.startActivity(intent);
            }
        });
        ...
        fullscreen.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(ProfileActivity.this,MapActivityView.class);
        ...
        String mobile = G.CUSTOMER_MOBILE.getString("CUSTOMER_MOBILE", "x");
        String email = G.CUSTOMER_EMAIL.getString("CUSTOMER_EMAIL", "x");
        String address = G.CUSTOMER_ADDRESS.getString("CUSTOMER_ADDRESS", "x");
        latitude = G.CUSTOMER_LAT.getString("CUSTOMER_LAT", String.valueOf(G.LATITUDE));
        longtitude = G.CUSTOMER_LNG.getString("CUSTOMER_LNG", String.valueOf(G.LONGTITUDE));

        activityRegister_name.setText(name);
        activityRegister_phone.setText(mobile);
        activityRegister_email.setText(email);
        activityRegister_address.setText(address);
...
//        dialogSuccess.setTitle("Custom Dialog");
        ...
        activityRegister_btn_register.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (fieldsAreFilled) {
                    try {
                        if (ActivityCompat.checkSelfPermission(ProfileActivity.this, mPermission[0]) != MockPackageManager.PERMISSION_GRANTED ||
                                ActivityCompat.checkSelfPermission(ProfileActivity.this, mPermission[1]) != MockPackageManager.PERMISSION_GRANTED ||
                                ActivityCompat.checkSelfPermission(ProfileActivity.this, mPermission[2]) != MockPackageManager.PERMISSION_GRANTED) {
                            ActivityCompat.requestPermissions(ProfileActivity.this, mPermission, REQUEST_CODE_PERMISSION);
...
//                cityName.add(title);
    ...
    private class UserDetailAsync extends Webservice.userDetail {
        @Override
        protected void onPreExecute() {
        }
...
//        lng = String.valueOf(latLng.longitude);
    ...
    public void uploadImage(File file) {
        ...
        myClient.post(url + cellphone, params, new AsyncHttpResponseHandler() {
            ...
            public void onSuccess(int i, Header[] headers, byte[] bytes) {
                try {
                    ...
                    if (jsonObject.getString("Code").equals("0")) {
                        Toast.makeText(ProfileActivity.this, "آپلود با موفقیت انجام شد", Toast.LENGTH_SHORT).show();
