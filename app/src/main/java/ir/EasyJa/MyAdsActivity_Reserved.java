...
public class MyAdsActivity_Reserved extends AppCompatActivity implements View.OnClickListener, OnMapReadyCallback,
    ...
    public static MyAdsActivity_Reserved activity;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        toolbar_main_tv_header.setText("اجاره داده شده");
        ...
        activity = MyAdsActivity_Reserved.this;
...
//                    Toast.makeText(MainActivity.this, "Tab " + tabLayout.getSelectedTabPosition(), Toast.LENGTH_LONG).show();
        ...
        activityRegister_btn_register.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (fieldsAreFilled) {
                    try {
                        if (ActivityCompat.checkSelfPermission(MyAdsActivity_Reserved.this, mPermission[0]) != MockPackageManager.PERMISSION_GRANTED ||
                                ActivityCompat.checkSelfPermission(MyAdsActivity_Reserved.this, mPermission[1]) != MockPackageManager.PERMISSION_GRANTED ||
                                ActivityCompat.checkSelfPermission(MyAdsActivity_Reserved.this, mPermission[2]) != MockPackageManager.PERMISSION_GRANTED) {
                            ActivityCompat.requestPermissions(MyAdsActivity_Reserved.this, mPermission, REQUEST_CODE_PERMISSION);
...
//        adapter_recycler.notifyDataSetChanged();
        ...
        adapter_recycler = new Adapter_Recycler_Ads(getApplicationContext(), arrayList, new OnItemListener() {
            ...
            public void onCardClick(int position) {
                Intent intent = new Intent(MyAdsActivity_Reserved.this, AdsActivity_inner.class);
                intent.putExtra("object", String.valueOf(arrayList.get(position).object));
                MyAdsActivity_Reserved.this.startActivity(intent);
            }
        ...
        protected void onPostExecute(String result) {
            ...
            try {
                ...
                try {
                    ...
                    Toast.makeText(MyAdsActivity_Reserved.this, message, Toast.LENGTH_SHORT).show();
...
//                String imageUrl = jsonObject.getString("ImageAddress");
                JSONArray jsonArray = jsonObject.getJSONArray("Reserved");
                for (int i = 0; i < jsonArray.length(); i++) {
                    ...
                    String RenterName = AdsShift1.getString("RenterName");
                    String RenterMobile = AdsShift1.getString("RenterMobile");
...
//                    struct.AdsShift1_Date = AdsShift1_Date;
                    ...
                    struct.name = name;
                    struct.renterName = RenterName;
                    struct.renterMobile = RenterMobile;
