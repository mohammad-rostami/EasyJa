...
public class Adapter_Recycler extends RecyclerView.Adapter<Adapter_Recycler.ViewHolder> {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        if (Tab == 31) {
            view = inflater.inflate(R.layout.item_instrument, parent, false);
        }
        if (Tab == 32) {
            view = inflater.inflate(R.layout.item_instrument_select, parent, false);
        }
...
//            holder.item_no.setEnabled(false);
        ...
        if (Tab == 32) {
            holder.item_title.setText(structs.get(position).strItemText);
            if (structs.get(position).isEnabled){
    ...
    public static class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(final View itemView) {
            ...
            item_switch = (Switch) itemView.findViewById(R.id.item_switch);
