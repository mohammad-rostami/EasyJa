...
public class FutureReservedAdsActivity extends AppCompatActivity implements View.OnClickListener, OnMapReadyCallback,
    ...
    public static FutureReservedAdsActivity activity;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        toolbar_main_tv_header.setText("رزروهای پیش رو");
        ...
        activity = FutureReservedAdsActivity.this;
...
//                    Toast.makeText(MainActivity.this, "Tab " + tabLayout.getSelectedTabPosition(), Toast.LENGTH_LONG).show();
        ...
        activityRegister_btn_register.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (fieldsAreFilled) {
                    try {
                        if (ActivityCompat.checkSelfPermission(FutureReservedAdsActivity.this, mPermission[0]) != MockPackageManager.PERMISSION_GRANTED ||
                                ActivityCompat.checkSelfPermission(FutureReservedAdsActivity.this, mPermission[1]) != MockPackageManager.PERMISSION_GRANTED ||
                                ActivityCompat.checkSelfPermission(FutureReservedAdsActivity.this, mPermission[2]) != MockPackageManager.PERMISSION_GRANTED) {
                            ActivityCompat.requestPermissions(FutureReservedAdsActivity.this, mPermission, REQUEST_CODE_PERMISSION);
...
//        adapter_recycler.notifyDataSetChanged();
        ...
        adapter_recycler = new Adapter_Recycler_Ads(getApplicationContext(), arrayList, new OnItemListener() {
            ...
            public void onCardClick(int position) {
                Intent intent = new Intent(FutureReservedAdsActivity.this, AdsActivityDetail.class);
                intent.putExtra("adID", String.valueOf(arrayList.get(position).AdsShift1_AdsId));
                FutureReservedAdsActivity.this.startActivity(intent);
            }
        ...
        list_mode.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                adapter_recycler = new Adapter_Recycler_Ads(getApplicationContext(), arrayList, new OnItemListener() {
                    ...
                    @Override
                    public void onCardClick(int position) {
                        Intent intent = new Intent(FutureReservedAdsActivity.this, AdsActivity_inner.class);
        ...
        protected void onPostExecute(String result) {
            ...
            try {
                ...
                try {
                    ...
                    Toast.makeText(FutureReservedAdsActivity.this, message, Toast.LENGTH_SHORT).show();
...
//        new resendAsync().execute(Urls.BASE_URL + Urls.GET_NEAR_STATES, String.valueOf(G.defaultGlat), String.valueOf(G.defaultGlng), typeId);
        new resendAsync().execute(Urls.BASE_URL + Urls.GET_RENT_LIST, cellPhone);


    }

    private class resendAsync extends Webservice.getRentList {
        @Override
        protected void onPreExecute() {
            arrayList.clear();
        }
        ...
        protected void onPostExecute(final String result) {
            ...
            try {
                ...
                JSONArray jsonArray = jsonObject.getJSONArray("FutureList");
