...
public class PastReservedAdsActivity extends AppCompatActivity implements View.OnClickListener, OnMapReadyCallback,
    ...
    public static PastReservedAdsActivity activity;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        toolbar_main_tv_header.setText("رزروهای گذشته");
        ...
        activity = PastReservedAdsActivity.this;
...
//                    Toast.makeText(MainActivity.this, "Tab " + tabLayout.getSelectedTabPosition(), Toast.LENGTH_LONG).show();
        ...
        activityRegister_btn_register.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (fieldsAreFilled) {
                    try {
                        if (ActivityCompat.checkSelfPermission(PastReservedAdsActivity.this, mPermission[0]) != MockPackageManager.PERMISSION_GRANTED ||
                                ActivityCompat.checkSelfPermission(PastReservedAdsActivity.this, mPermission[1]) != MockPackageManager.PERMISSION_GRANTED ||
                                ActivityCompat.checkSelfPermission(PastReservedAdsActivity.this, mPermission[2]) != MockPackageManager.PERMISSION_GRANTED) {
                            ActivityCompat.requestPermissions(PastReservedAdsActivity.this, mPermission, REQUEST_CODE_PERMISSION);
...
//                Intent intent = new Intent(PastReservedAdsActivity.this, AdsActivity_inner.class);
//                intent.putExtra("object", String.valueOf(arrayList.get(position).object));
//                PastReservedAdsActivity.this.startActivity(intent);

                Intent intent = new Intent(PastReservedAdsActivity.this, AdsActivityDetail.class);
        ...
        protected void onPostExecute(String result) {
            ...
            try {
                ...
                try {
                    ...
                    Toast.makeText(PastReservedAdsActivity.this, message, Toast.LENGTH_SHORT).show();
